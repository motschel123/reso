...
// in reso/test/business_logic/providers/auth_manager_test.dart.
...
class MockFirebaseAuth extends _i1.Mock implements _i3.FirebaseAuth {
  ...
  _i6.Stream<_i3.User?> authStateChanges() =>
      (super.noSuchMethod(Invocation.method(#authStateChanges, []),
          returnValue: Stream<_i3.User?>.empty()) as _i6.Stream<_i3.User?>);
  @override
  ...
  _i6.Future<_i3.UserCredential> signInWithEmailLink(
      ...
      (super.noSuchMethod(
          ...
          returnValue:
              Future<_i3.UserCredential>.value(_FakeUserCredential_2())) as _i6
          .Future<_i3.UserCredential>);
  @override
  _i6.Future<_i3.ConfirmationResult> signInWithPhoneNumber(String? phoneNumber,
          [_i3.RecaptchaVerifier? verifier]) =>
      (super.noSuchMethod(
